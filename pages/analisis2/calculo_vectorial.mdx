...
> Sea $\mathbf{n}$ un vector perpendicular a un plano y un punto $P_0$ por el que pasa, entonces la **ecuación normal de un plano** es:
...
> Sean $\overline{\underline{X}} = (x, y, z), \; P_0 = (x_0, y_0, z_0), \; \mathbf{n} = (a, b, c)$, entonces la **ecuación cartesiana de un plano** es:
...
Esto nos sirve para pasar la ecuación vectorial del plano a la ecuación noraml del plano.
...
```math
Im(f) = \{ (y_1, y_2, y_3) \in \mathbb{R}^3 : (y_1, y_2, y_3) = t \cdot (1, -1, 2) + (0, 2, 3), r \in \mathbb{R} \}
```
