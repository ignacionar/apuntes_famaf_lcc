...
Donde $q$ es el _cociente_ y $r$ es el _resto_ de dividir $b$ por $a$. 
...
\begin{align*}
0 \leq r < 3 
&\implies 0 \leq r^2 < 3, \;r^2 \in \{0, 1\} \\ 
\end{align*}
```
...
```math 
\begin{align*}
mcd(72, 174) = (72, 174 - 72) = (72, 102) \\
mcd(72, 102) = (72, 102 - 72) = (72, 30) \\
mcd(30, 72) = (30, 72 - 30) = (30, 42) \\
mcd(30, 42) = (30, 42 - 30) = (30, 12) \\
mcd(12, 30) = (12, 30 - 12) = (12, 18) \\
mcd(12, 18) = (12, 18 - 12) = (12, 6) \\
mcd(6, 12) = (6, 12 - 6) = (6, 6) = 6
\end{align*}
```

**Tenemos la propiedad de que** $mcd(a, b) = mcd(a, b - a)$
